...
class Robot : public rclcpp::Node {
 ...
 private:
    ...
    bool dijkstra_search(
        const std::vector<int8_t>& map_data, int width, int height,   // 这里改为int8_t
    ...
    std::vector<std::pair<int, int>> current_path_; // 路径坐标
    size_t path_index_ = 0; // 路径进度
